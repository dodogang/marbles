...
public class MarblesFeatures {
    ...
    public static final Feature<DefaultFeatureConfig> SNOW_UNDER_TREES = register("snow_under_trees", new SnowUnderTreesFeature(DefaultFeatureConfig.CODEC));
    public static final Feature<PermafrostIceSpikeFeatureConfig> PERMAFROST_ICE_SPIKE = register("permafrost_ice_spike", new PermafrostIceSpikeFeature(PermafrostIceSpikeFeatureConfig.CODEC));
