...
public class MarblesBiomes {
     ...
     */
    public static Biome createNormalYellowBambooJungle() {
     ...
     */
    public static Biome createYellowBambooJungleHills() {
     ...
     */
    private static Biome createYellowBambooJungle(float depth, float scale, int parrotWeight, int parrotMaxGroupSize) {
     ...
     */
    private static Biome createJungleFeatures(float depth, float scale, float downfall, boolean yellowBambooJungle, boolean edge, boolean noStructures, SpawnSettings.Builder spawnSettings) {
