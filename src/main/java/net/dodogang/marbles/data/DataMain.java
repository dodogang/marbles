...
import net.dodogang.marbles.data.loottables.MarblesLootTablesProvider;
import net.dodogang.marbles.data.models.MarblesStateModelProvider;
import net.dodogang.marbles.data.recipes.MarblesRecipeProvider;
import net.dodogang.marbles.data.recipes.MarblesStonecuttingRecipeProvider;
import net.dodogang.marbles.data.tags.MarblesBlockItemTagProvider;
