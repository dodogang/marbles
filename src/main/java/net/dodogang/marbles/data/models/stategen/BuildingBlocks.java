...
import net.dodogang.marbles.data.models.modelgen.InheritingModelGen;
import net.dodogang.marbles.data.models.modelgen.ModelGen;
import net.minecraft.block.enums.BlockHalf;
import net.minecraft.util.math.Direction;

import static net.dodogang.marbles.data.models.modelgen.InheritingModelGen.fencePost;
import static net.dodogang.marbles.data.models.modelgen.InheritingModelGen.fenceSide;
