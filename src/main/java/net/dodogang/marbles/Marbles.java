...
import net.dodogang.marbles.tag.*;
    ...
    public void onInitialize() {
        if (!initialized) { // We need this because data gen may do an early initialization call
            ...
            Reflection.initialize(
                MarblesBlockTags.class,
                MarblesEntityTypeTags.class,
                MarblesItemTags.class,
                ...
                MarblesTrackedDataHandlers.class,
                MarblesEntities.class,

                MarblesBlockEntities.class,
